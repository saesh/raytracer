...
pub fn map_color_256(color: Color) -> [u8; 3] {
    [
        (256.0 * utils::clamp(color.r, 0.0, 0.999)) as u8,
        (256.0 * utils::clamp(color.g, 0.0, 0.999)) as u8, 
        (256.0 * utils::clamp(color.b, 0.0, 0.999)) as u8,
    ]
}